              ...
              <p className='text-gray-400'>
                ...
                <div className='pr-4'>
                    <GoogleLogin 
                      ...
                      render={ (renderProps)=> (
                        <button
                        className='bg-white text-lg text-[#fe2c55] border-[1px] border-[#fe2c55] font-semibold px-3 py-3 rounded-md outline-none w-full mt-3 hover:text-white hover:bg-[#fe2c55] cursor-pointer'
